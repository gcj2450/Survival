...
public class testInst2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Render
        Graphics.DrawMeshInstancedIndirect(instanceMesh, subMeshIndex, instanceMaterial, new Bounds(Vector3.zero, new Vector3(10.0f, 10.0f, 10.0f)), argsBuffer);
    }
    ...
    void UpdateBuffers()
    {
        ...
        for (int i = 0; i < instanceCount; i++)
        {
            ...
            positions[i] = new Vector4(distance, height, distance, size);
        }
